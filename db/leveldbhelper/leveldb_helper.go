...
func (dbInst *DB) Open() {
	...
	var err error
	var dirEmpty bool
	if dirEmpty, err = utils.CreateDirIfMissing(dbPath); err != nil {
...
func (dbInst *DB) Get(key []byte) ([]byte, error) {
	...
	if err != nil {
		log.Errorf("Error while trying to retrieve key [%#v]: %s", key, err)
		return nil, err
	}
	return value, nil
}
...
func (dbInst *DB) Put(key []byte, value []byte, sync bool) error {
	...
	if err != nil {
		log.Errorf("Error while trying to write key [%#v]", key)
		return err
	}
	return nil
}
...
func (dbInst *DB) Delete(key []byte, sync bool) error {
	...
	if err != nil {
		log.Errorf("Error while trying to delete key [%#v]", key)
		return err
	}
	return nil
}
